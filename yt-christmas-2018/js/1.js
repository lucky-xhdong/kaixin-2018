...
(function ($) {
    ...
    Richman.prototype = {
        ...
        forwards: function(currentIndex, targetIndex){
            currentIndex++;
            $(".nr-gird-" + currentIndex).addClass('current').siblings().removeClass('current');
        ...
        gridRoll: function () {
            ...
            function rotate() {
                switch (_this.direction) {
                    case 'forwards':
                        _this.forwards(RichmanOpitons.index, _this.targetIndex);
                ...
                switch (true) {
                    case RichmanOpitons.index == _this.forwardIndex && _this.targetIndex == _this.forwardIndex://前进5步：当小人走到’前进5步‘(也就是图中格子4)，在格子4停顿1秒再向前走6步，到格子10
                        ...
                        setTimeout(function () {
                            _this.timeOut1 = setTimeout(rotate, 500);
                        }, 1000);
            ...
            clearTimeout(_this.timeOut1);
            this.timeOut1 = setTimeout(rotate, 500);
        }
    };
...
$(document).ready(function () {
    ...
    //RichmanOpitons.index = 5;
    RichmanOpitons.number = 5;
    $('.btn-signin').on('click', function () {
        $(".christmas-richman").Richman();
    })
